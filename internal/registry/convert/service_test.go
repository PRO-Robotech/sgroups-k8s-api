...
func TestServiceConversion(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			require.Len(t, got.Spec.Transports, len(tt.in.Spec.Transports))
			for i, tr := range tt.in.Spec.Transports {
				...
				require.Len(t, got.Spec.Transports[i].Entries, len(tr.Entries))
...
func TestServiceFromProtoExt(t *testing.T) {
	...
	require.Len(t, got.Spec.Transports, 1)
	...
	require.Len(t, got.Spec.Transports[0].Entries, 1)
