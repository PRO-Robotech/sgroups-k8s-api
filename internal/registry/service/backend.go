...
func (b *backend) Resource() schema.GroupResource {
	return v1alpha1.Resource(v1alpha1.ResourceServices)
}

func (b *backend) List(ctx context.Context, sel base.Selection) (*v1alpha1.ServiceList, error) {
	...
	req := &sgroupsv1.ServiceReq_List{Selectors: []*common.ResSelector{resSelector}}
	resp, err := b.client.Services.List(ctx, req)
	if err != nil {
		return nil, regerrors.FromGRPC(err, b.Resource(), sel.Name)
	}

	out := &v1alpha1.ServiceList{
		TypeMeta: metav1.TypeMeta{
			Kind:       v1alpha1.KindServiceList,
			APIVersion: v1alpha1.SchemeGroupVersion.String(),
		},
		Items: make([]v1alpha1.Service, 0, len(resp.GetServices())),
	}
	out.ResourceVersion = resp.GetResourceVersion()
	for _, svc := range resp.GetServices() {
		if converted := convert.ServiceFromProtoExt(svc); converted != nil {
...
func (b *backend) Upsert(ctx context.Context, obj *v1alpha1.Service) (*v1alpha1.Service, error) {
	req := &sgroupsv1.ServiceReq_Upsert{
		Services: []*sgroupsv1.Service{convert.ServiceToProto(obj)},
	}
	resp, err := b.client.Services.Upsert(ctx, req)
	if err != nil {
	...
	return convert.ServiceFromProto(resp.GetServices()[0]), nil
}

func (b *backend) Delete(ctx context.Context, name, namespace string) error {
	req := &sgroupsv1.ServiceReq_Delete{
		Services: []*sgroupsv1.ServiceReq_Delete_Service{
			{
	...
	_, err := b.client.Services.Delete(ctx, req)
	if err != nil {
...
func (b *backend) Watch(ctx context.Context, sel base.Selection, resourceVersion string) (watch.Interface, error) {
	...
	req := &sgroupsv1.ServiceReq_Watch{
		ResourceVersion: resourceVersion,
		Selectors:       []*common.ResSelector{resSelector},
	}
	ctx, cancel := context.WithCancel(ctx)
	stream, err := b.client.Services.Watch(ctx, req)
	if err != nil {
		cancel()
	...
	return base.NewStreamWatch(
		cancel,
		stream.Recv,
		func(evt *sgroupsv1.ServiceResp_Watch) common.WatchEventType {
			return evt.GetType()
		},
		func(evt *sgroupsv1.ServiceResp_Watch) []*sgroupsv1.ServiceResp_ServiceExt {
			return evt.GetServices()
		},
		func(svc *sgroupsv1.ServiceResp_ServiceExt) runtime.Object {
			return convert.ServiceFromProtoExt(svc)
		},
	), nil
}
